...
<body>
    ...
    <div class="form-check d-flex justify-content-center mb-5">
        ...
        <label class="form-check-label" for="form2Example3g"> 
            Tôi xác nhận đồng ý với điều khoản và điều kiện <a href="#!" class="text-body"><u>Điều khoản và điều kiện </u></a>
        </label>
    </div>
    ...
    if (!countdownExpired) { // Kiểm tra nếu chưa hết thời gian
        if (firstClick) {
            ...
            if (authSDt == null || authSDt === "") {
                ...
                // Mã xác thực đã tồn tại, không cần lấy mã mới
                document.getElementById("codegmail").value = ''; // Gán giá trị mã xác thực cho trường nhập mã xác thực
