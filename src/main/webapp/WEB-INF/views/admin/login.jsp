...
<h3 class="mb-3 pb-3 text-center" style="font-size: xx-large;;letter-spacing: 1px; font-weight: bold; font-family: 'Pacifico', cursive; color: #3498db; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);"> Admin Login</h3>
                  ...
                  <div class="pt-1 text-center mt-3">
					...
					<button type="button" class="btn btn-secondary">Forgot Pass</button>
                  </div>
                  ...
                  <p style="text-align: center;">Don't have an account? <a href="#!" class="link-info">Register here</a></p>
